...
urlpatterns = [
    ...
    path('admin/survey/<int:survey_id>/toggle-status/', admin_views.admin_survey_toggle_status, name='admin_survey_toggle_status'),
    ...
    path('admin/survey/<int:survey_id>/participants/', admin_views.admin_survey_participants, name='admin_survey_participants'),
    path('admin/survey/<int:survey_id>/statistics/', admin_views.admin_survey_statistics, name='admin_survey_statistics'),
    path('admin/survey/<int:survey_id>/report/download/', admin_views.admin_survey_report_download, name='admin_survey_report_download'),
